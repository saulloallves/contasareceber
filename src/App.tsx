        ...
        return cnpjSelecionado ? (
          ...
          <div className="max-w-4xl mx-auto p-6">
            <div className="bg-white rounded-lg shadow-lg p-8 text-center">
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Linha do Tempo da Unidade</h2>
              <p className="text-gray-600 mb-6">Digite o CNPJ da unidade para visualizar o histórico completo</p>
